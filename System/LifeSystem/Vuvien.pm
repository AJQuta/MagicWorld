...
sub new($$$$$$$) {
  my($class) = @_;shift;
  my $self = $class->SUPER::new(shift, shift, shift, shift, shift, shift, SightPotion, shift);
  bless $self, $class;
  $self;
}
...
sub setPotionStat($) {
  ...
  return $self->{potion_stat} unless $potion_stat eq SightPotion ||
    $potion_stat eq HealthPotion;
